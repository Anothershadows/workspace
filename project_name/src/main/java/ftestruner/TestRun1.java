...
public class TestRun1 {
	...
	public void userSearchesForA(String book) {
		driver.findElement(By.xpath("//input[contains(@class,'mat-mdc-autocomplete-trigger searchbox')]"))
				.sendKeys(book);
...
/*
 * String bagh =driver.findElement(By.id("mat-badge-content-0")).getText(); try
 * { Thread.sleep(10000); } catch (InterruptedException e) { // TODO
 * Auto-generated catch block e.printStackTrace(); }
 * Assert.assertEquals(Integer.parseInt(bagh)>0 , true); driver.quit(); }/* }
 * 
 * 
 * /*
 * 
